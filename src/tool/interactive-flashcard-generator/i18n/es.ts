...
const slug = 'generador-interactivo-de-flashcards' as const;
...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Cómo diseñar una buena tarjeta', level: 3 },
    { type: 'paragraph', html: 'Escribe una pregunta concreta en el frente y una respuesta breve en el reverso. Una tarjeta debe comprobar una idea, no copiar una página completa de apuntes.' },
    { type: 'title', text: 'Programa repasos con intención', level: 3 },
    { type: 'paragraph', html: 'Marca las tarjetas difíciles y vuelve a ellas con más frecuencia. Espaciar las tarjetas conocidas libera tiempo para los conceptos que todavía necesitan práctica.' },
    { type: 'paragraph', html: 'Después de cada sesión, revisa tus errores y modifica las tarjetas ambiguas. La calidad del mazo determina la calidad del repaso.' },
    { type: 'paragraph', html: 'Relaciona cada tarjeta con un ejemplo práctico para comprobar que puedes aplicar el concepto fuera del contexto del mazo.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
