...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Membuat kartu yang jelas', level: 3 },
    { type: 'paragraph', html: 'Tulis pertanyaan yang spesifik di bagian depan dan jawaban singkat di bagian belakang. Satu kartu sebaiknya menguji satu gagasan.' },
    { type: 'title', text: 'Menjadwalkan ulasan', level: 3 },
    { type: 'paragraph', html: 'Tandai kartu yang sulit dan ulangi lebih sering. Kartu yang sudah dikuasai dapat diberi jarak agar waktu belajar lebih efisien.' },
    { type: 'title', text: 'Meningkatkan dek', level: 3 },
    { type: 'paragraph', html: 'Setelah sesi selesai, perbaiki kartu yang ambigu dan tambahkan contoh jika konsepnya masih sulit.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
