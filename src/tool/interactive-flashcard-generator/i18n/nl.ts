...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Een duidelijke kaart maken', level: 3 },
    { type: 'paragraph', html: 'Schrijf een concrete vraag aan de voorkant en een kort antwoord aan de achterkant. Een kaart hoort een idee te toetsen, niet een hele pagina te kopiëren.' },
    { type: 'title', text: 'Herhalingen plannen', level: 3 },
    { type: 'paragraph', html: 'Markeer moeilijke kaarten en herhaal ze vaker. Kaarten die je beheerst kunnen meer ruimte krijgen zodat je tijd overhoudt.' },
    { type: 'title', text: 'De stapel verbeteren', level: 3 },
    { type: 'paragraph', html: 'Pas na elke sessie onduidelijke kaarten aan en voeg een voorbeeld toe wanneer een begrip lastig blijft.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
