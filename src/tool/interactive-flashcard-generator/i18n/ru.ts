...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Создание понятной карточки', level: 3 },
    { type: 'paragraph', html: 'Запишите точный вопрос на лицевой стороне и короткий ответ на обратной. Одна карточка должна проверять одну мысль.' },
    { type: 'title', text: 'Планирование повторений', level: 3 },
    { type: 'paragraph', html: 'Отмечайте трудные карточки и повторяйте их чаще. Освоенные карточки можно разносить по времени для большей эффективности.' },
    { type: 'title', text: 'Улучшение набора', level: 3 },
    { type: 'paragraph', html: 'После занятия исправляйте неясные карточки и добавляйте пример, если понятие остаётся сложным.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
