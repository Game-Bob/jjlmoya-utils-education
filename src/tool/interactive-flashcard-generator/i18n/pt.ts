...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Criar um cartão claro', level: 3 },
    { type: 'paragraph', html: 'Escreva uma pergunta concreta na frente e uma resposta curta no verso. Cada cartão deve testar uma ideia.' },
    { type: 'title', text: 'Planear as revisões', level: 3 },
    { type: 'paragraph', html: 'Marque os cartões difíceis e reveja-os com maior frequência. Afaste os cartões já dominados para estudar de forma mais eficiente.' },
    { type: 'title', text: 'Melhorar o baralho', level: 3 },
    { type: 'paragraph', html: 'Depois de cada sessão, corrija cartões ambíguos e acrescente um exemplo quando o conceito continuar difícil.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
