...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Créer une carte claire', level: 3 },
    { type: 'paragraph', html: 'Écrivez une question précise au recto et une réponse courte au verso. Une carte doit tester une idée, pas reproduire une page entière.' },
    { type: 'title', text: 'Planifier les révisions', level: 3 },
    { type: 'paragraph', html: 'Marquez les cartes difficiles et revoyez-les plus souvent. Les cartes maîtrisées peuvent être espacées pour libérer du temps.' },
    { type: 'title', text: 'Améliorer le paquet', level: 3 },
    { type: 'paragraph', html: 'Après chaque session, corrigez les cartes ambiguës et ajoutez un exemple lorsque le concept reste difficile.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
