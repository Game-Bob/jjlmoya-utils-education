...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Tworzenie jasnej karty', level: 3 },
    { type: 'paragraph', html: 'Zapisz konkretne pytanie z przodu i krótką odpowiedź z tyłu. Jedna karta powinna sprawdzać jedną myśl.' },
    { type: 'title', text: 'Planowanie powtórek', level: 3 },
    { type: 'paragraph', html: 'Oznacz trudne karty i powtarzaj je częściej. Karty już opanowane można rozsuwać w czasie, aby uczyć się efektywniej.' },
    { type: 'title', text: 'Ulepszanie talii', level: 3 },
    { type: 'paragraph', html: 'Po sesji popraw niejasne karty i dodaj przykład, jeśli dane pojęcie nadal sprawia trudność.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
