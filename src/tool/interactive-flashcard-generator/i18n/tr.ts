...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Açık bir kart oluşturma', level: 3 },
    { type: 'paragraph', html: 'Ön yüze net bir soru, arka yüze kısa bir cevap yazın. Her kart tek bir düşünceyi ölçmelidir.' },
    { type: 'title', text: 'Tekrarları planlama', level: 3 },
    { type: 'paragraph', html: 'Zor kartları işaretleyip daha sık tekrarlayın. Öğrendiğiniz kartların aralığını açarak zamanı verimli kullanın.' },
    { type: 'title', text: 'Desteyi geliştirme', level: 3 },
    { type: 'paragraph', html: 'Her oturumdan sonra belirsiz kartları düzeltin ve zor kalan kavramlara örnek ekleyin.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
