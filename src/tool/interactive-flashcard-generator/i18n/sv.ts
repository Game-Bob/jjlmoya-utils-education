...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Skapa ett tydligt kort', level: 3 },
    { type: 'paragraph', html: 'Skriv en konkret fråga på framsidan och ett kort svar på baksidan. Ett kort bör testa en idé i taget.' },
    { type: 'title', text: 'Planera repetitionerna', level: 3 },
    { type: 'paragraph', html: 'Markera svåra kort och repetera dem oftare. Kort som du kan får längre mellanrum så att tiden används bättre.' },
    { type: 'title', text: 'Förbättra kortleken', level: 3 },
    { type: 'paragraph', html: 'Efter varje pass ändrar du otydliga kort och lägger till ett exempel när ett begrepp fortfarande är svårt.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
