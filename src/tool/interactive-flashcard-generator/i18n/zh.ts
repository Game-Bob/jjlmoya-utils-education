...
const faqItems = [
  ...
  { question: '如何保存我自定义的卡片？', answer: '您可以将您的牌组导出为 JSON 文件。之后要继续学习，只需点击“导入”按钮并上传该文件即可。' },
  { question: '简单、一般和困难的评估有什么用？', answer: '它们帮助您分类对卡片的掌握程度。在莱特纳（Leitner）系统中，较难的卡片会被更频繁地复习，以强化神经元连接。' },
];

const howToItems = [
  { name: '创建卡片', text: '在正面（问题）输入问题或概念，在背面（答案）输入回答或解释，然后点击“添加卡片”。' },
  { name: '复习牌组', text: '点击视窗内的卡片即可翻转并显示答案。' },
  { name: '评估记忆', text: '使用“简单”、“一般”或“困难”按钮评估您回忆答案的轻松程度。' },
  { name: '保存学习进度', text: '使用“导出”按钮下载您的自定义牌组，以便日后重新加载。' },
];
