...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: '制作清晰的卡片', level: 3 },
    { type: 'paragraph', html: '正面写出具体问题，背面写出简短答案。一张卡片最好只检查一个知识点。' },
    { type: 'title', text: '安排复习间隔', level: 3 },
    { type: 'paragraph', html: '标记较难的卡片并增加复习频率。已经掌握的卡片可以拉长间隔，让学习时间更高效。' },
    { type: 'title', text: '改进卡片组', level: 3 },
    { type: 'paragraph', html: '每次学习后修改含义不清的卡片，并为仍然困难的概念补充例子。' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
