...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: '分かりやすいカードを作る', level: 3 },
    { type: 'paragraph', html: '表には具体的な質問、裏には短い答えを書きます。一枚のカードでは一つの考えを確認しましょう。' },
    { type: 'title', text: '復習の間隔を決める', level: 3 },
    { type: 'paragraph', html: '難しいカードには短い間隔で戻り、覚えたカードは間隔を広げると学習時間を有効に使えます。' },
    { type: 'title', text: 'デッキを改善する', level: 3 },
    { type: 'paragraph', html: 'セッション後に曖昧なカードを修正し、理解しにくい概念には具体例を追加してください。' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
