...
export const content: ToolLocaleContent<InteractiveFlashcardGeneratorUI> = {
  ...
  seo: [
    ...
    { type: 'title', text: '명확한 카드 만들기', level: 3 },
    { type: 'paragraph', html: '앞면에는 구체적인 질문을, 뒷면에는 짧은 답을 적으세요. 한 장의 카드는 하나의 개념을 확인해야 합니다.' },
    { type: 'title', text: '복습 간격 정하기', level: 3 },
    { type: 'paragraph', html: '어려운 카드는 더 자주 복습하고 이미 익힌 카드는 간격을 늘리면 학습 시간을 효율적으로 사용할 수 있습니다.' },
    { type: 'title', text: '덱 개선하기', level: 3 },
    { type: 'paragraph', html: '세션이 끝난 뒤 모호한 카드를 고치고 이해하기 어려운 개념에는 예시를 추가하세요.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
