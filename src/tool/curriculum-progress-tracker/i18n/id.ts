...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Tetapkan jumlah kredit yang dibutuhkan untuk lulus, lalu bagi mata kuliah tersisa ke semester yang realistis.' },
    { type: 'paragraph', html: 'Kredit yang selesai menunjukkan kemajuan nyata, sedangkan mata kuliah terencana hanya digunakan untuk simulasi.' },
    { type: 'paragraph', html: 'Nilai rata-rata proyeksi bergantung pada perkiraan nilai yang Anda masukkan untuk mata kuliah berikutnya.' },
    { type: 'paragraph', html: 'Bandingkan beberapa asumsi agar satu perkiraan nilai tidak dianggap sebagai kepastian.' },
    { type: 'paragraph', html: 'Nilai yang diperlukan menunjukkan performa yang dibutuhkan pada mata kuliah tersisa untuk mencapai target.' },
    { type: 'paragraph', html: 'Semester yang lebih ringan dapat menjaga konsistensi, sementara beban penuh dapat mempercepat pengumpulan kredit.' },
    { type: 'paragraph', html: 'Pertimbangkan waktu yang tersedia dan beban kerja setiap mata kuliah saat membandingkan rencana.' },
    { type: 'paragraph', html: 'Ekspor rencana sebelum perubahan besar agar skenario lama tetap dapat dibandingkan.' },
    { type: 'paragraph', html: 'Gunakan status selesai, sedang berjalan, dan direncanakan supaya simulasi mudah dipahami.' },
    { type: 'paragraph', html: 'Perhitungan ini adalah panduan umum dan bukan pengganti konsultasi akademik.' },
    { type: 'paragraph', html: 'Periksa bobot nilai, aturan kompensasi, dan syarat kelulusan khusus di universitas Anda.' },
    { type: 'paragraph', html: 'Simpan data secara lokal dan perbarui setelah hasil resmi setiap mata kuliah diterbitkan.' },
    { type: 'paragraph', html: 'Rencana yang realistis membantu Anda mengukur kemajuan dan mencari bantuan lebih awal.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
