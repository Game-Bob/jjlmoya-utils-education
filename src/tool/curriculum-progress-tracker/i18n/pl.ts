...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Ustal łączną liczbę punktów potrzebnych do ukończenia studiów i rozdziel pozostałe przedmioty na realne semestry.' },
    { type: 'paragraph', html: 'Zdobyte punkty pokazują rzeczywisty postęp, a zaplanowane przedmioty służą tylko do symulacji przyszłych wyników.' },
    { type: 'paragraph', html: 'Przewidywana średnia zależy od szacowanych ocen wpisanych dla pozostałych przedmiotów.' },
    { type: 'paragraph', html: 'Porównuj kilka założeń, zamiast traktować jedną prognozę jak pewnik.' },
    { type: 'paragraph', html: 'Wymagana ocena pokazuje poziom potrzebny do osiągnięcia wybranego celu.' },
    { type: 'paragraph', html: 'Lżejszy semestr może poprawić regularność, a większe obciążenie może przyspieszyć zdobywanie punktów.' },
    { type: 'paragraph', html: 'Przy porównywaniu planów uwzględnij dostępny czas i rzeczywisty nakład pracy każdego przedmiotu.' },
    { type: 'paragraph', html: 'Wyeksportuj plan przed dużą zmianą, aby później porównać wcześniejsze scenariusze.' },
    { type: 'paragraph', html: 'Statusy ukończony, w toku i zaplanowany pomagają zachować czytelność symulacji.' },
    { type: 'paragraph', html: 'Obliczenie jest ogólną wskazówką i nie zastępuje konsultacji akademickiej.' },
    { type: 'paragraph', html: 'Sprawdź w regulaminie uczelni wagi ocen, zasady kompensacji i wymagania ukończenia.' },
    { type: 'paragraph', html: 'Aktualizuj lokalnie zapisane dane po każdym oficjalnie opublikowanym wyniku.' },
    { type: 'paragraph', html: 'Realistyczny plan ułatwia pomiar postępów i wcześniejsze szukanie pomocy.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
