...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Stel het totale aantal studiepunten voor je diploma vast en verdeel resterende vakken over haalbare semesters.' },
    { type: 'paragraph', html: 'Behaalde studiepunten tonen echte voortgang, terwijl geplande vakken alleen toekomstige scenario\'s simuleren.' },
    { type: 'paragraph', html: 'Het verwachte gemiddelde hangt af van de geschatte cijfers die je voor resterende vakken invoert.' },
    { type: 'paragraph', html: 'Vergelijk meerdere aannames in plaats van één voorspelling als zekerheid te behandelen.' },
    { type: 'paragraph', html: 'Het vereiste cijfer laat zien welke prestatie nodig is om je doel te bereiken.' },
    { type: 'paragraph', html: 'Een lichter semester kan stabiliteit geven, terwijl een voller plan studiepunten sneller kan opleveren.' },
    { type: 'paragraph', html: 'Houd bij het vergelijken rekening met beschikbare tijd en de echte werkbelasting van elk vak.' },
    { type: 'paragraph', html: 'Exporteer je plan voor grote wijzigingen zodat je eerdere scenario\'s kunt vergelijken.' },
    { type: 'paragraph', html: 'Gebruik statussen voor afgeronde, lopende en geplande vakken om de simulatie duidelijk te houden.' },
    { type: 'paragraph', html: 'Deze berekening is een algemene leidraad en vervangt geen studieadvies van je instelling.' },
    { type: 'paragraph', html: 'Controleer wegingsfactoren, compensatieregels en afstudeereisen in je officiële reglement.' },
    { type: 'paragraph', html: 'Werk lokale gegevens bij nadat elk officieel resultaat is gepubliceerd.' },
    { type: 'paragraph', html: 'Een realistisch plan helpt je voortgang te meten en op tijd ondersteuning te zoeken.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
