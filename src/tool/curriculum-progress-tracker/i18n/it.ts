...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Imposta i crediti totali richiesti per la laurea e distribuisci gli esami rimanenti in semestri realistici.' },
    { type: 'paragraph', html: 'I crediti completati descrivono i progressi reali, mentre gli esami pianificati servono solo per simulare il futuro.' },
    { type: 'paragraph', html: 'La media prevista dipende dai voti stimati inseriti per gli esami ancora da sostenere.' },
    { type: 'paragraph', html: 'Confronta più ipotesi invece di considerare certa una singola previsione.' },
    { type: 'paragraph', html: 'Il voto richiesto indica quale rendimento serve negli esami restanti per raggiungere l obiettivo.' },
    { type: 'paragraph', html: 'Un semestre leggero può favorire la continuità, mentre un carico maggiore può accelerare l accumulo dei crediti.' },
    { type: 'paragraph', html: 'Valuta il piano insieme al tempo disponibile e alla difficoltà effettiva degli insegnamenti.' },
    { type: 'paragraph', html: 'Esporta il piano prima di modifiche importanti per poter confrontare gli scenari precedenti.' },
    { type: 'paragraph', html: 'Usa gli stati completato, in corso e pianificato per mantenere chiara la simulazione.' },
    { type: 'paragraph', html: 'Il calcolo è un orientamento generale e non sostituisce il supporto della segreteria o dei tutor.' },
    { type: 'paragraph', html: 'Controlla pesi, regole di compensazione e requisiti specifici del tuo ateneo.' },
    { type: 'paragraph', html: 'Conserva i dati localmente e aggiornali dopo ogni risultato ufficiale.' },
    { type: 'paragraph', html: 'Un piano realistico aiuta a misurare i progressi e a chiedere supporto in tempo.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
