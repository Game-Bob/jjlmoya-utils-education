...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Defina o total de créditos necessários para o curso e distribua as disciplinas restantes por semestres realistas.' },
    { type: 'paragraph', html: 'Os créditos concluídos mostram o progresso real, enquanto as disciplinas planeadas servem apenas para simular resultados futuros.' },
    { type: 'paragraph', html: 'A média prevista depende das notas estimadas que introduzir para as disciplinas em falta.' },
    { type: 'paragraph', html: 'Compare vários pressupostos em vez de tratar uma única previsão como certeza.' },
    { type: 'paragraph', html: 'A nota necessária mostra o desempenho exigido nas disciplinas restantes para alcançar o objetivo.' },
    { type: 'paragraph', html: 'Um semestre mais leve pode melhorar a consistência, enquanto uma carga maior pode acelerar a obtenção de créditos.' },
    { type: 'paragraph', html: 'Considere o tempo disponível e o esforço real de cada disciplina ao comparar planos.' },
    { type: 'paragraph', html: 'Exporte o plano antes de alterações importantes para poder comparar cenários anteriores.' },
    { type: 'paragraph', html: 'Use os estados concluído, em curso e planeado para manter a simulação compreensível.' },
    { type: 'paragraph', html: 'Este cálculo é uma orientação geral e não substitui o aconselhamento da instituição.' },
    { type: 'paragraph', html: 'Confirme pesos, regras de compensação e requisitos de conclusão no regulamento oficial.' },
    { type: 'paragraph', html: 'Atualize os dados guardados localmente depois de cada resultado oficial.' },
    { type: 'paragraph', html: 'Um plano realista ajuda a medir o progresso e a procurar apoio atempadamente.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
