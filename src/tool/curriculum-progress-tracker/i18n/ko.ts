...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: '졸업에 필요한 총 학점을 정하고 남은 과목을 현실적인 학기에 나누어 배치하세요.' },
    { type: 'paragraph', html: '이수 학점은 실제 진행 상황을 나타내며 계획한 과목은 미래 결과를 시뮬레이션하는 데 사용됩니다.' },
    { type: 'paragraph', html: '예상 평균은 남은 과목에 입력한 예상 성적에 따라 달라집니다.' },
    { type: 'paragraph', html: '하나의 예상값을 확정값으로 보지 말고 여러 조건을 비교하세요.' },
    { type: 'paragraph', html: '필요 성적을 확인하면 목표를 위해 남은 과목에서 필요한 수준을 알 수 있습니다.' },
    { type: 'paragraph', html: '가벼운 학기는 안정성을 높이고 높은 학점 부담은 학점 취득을 앞당길 수 있습니다.' },
    { type: 'paragraph', html: '계획을 비교할 때 사용 가능한 시간과 과목별 실제 학습량을 함께 고려하세요.' },
    { type: 'paragraph', html: '큰 변경 전에 계획을 내보내면 이전 시나리오를 나중에 비교할 수 있습니다.' },
    { type: 'paragraph', html: '완료, 진행 중, 예정 상태를 사용하면 시뮬레이션을 쉽게 이해할 수 있습니다.' },
    { type: 'paragraph', html: '이 계산은 일반적인 참고 자료이며 학교의 학업 상담을 대신하지 않습니다.' },
    { type: 'paragraph', html: '성적 가중치와 보상 규칙 및 졸업 요건은 학교 규정을 확인하세요.' },
    { type: 'paragraph', html: '공식 성적이 발표될 때마다 기기에 저장된 계획을 업데이트하세요.' },
    { type: 'paragraph', html: '현실적인 계획은 진행 상황을 측정하고 필요한 도움을 일찍 요청하는 데 도움이 됩니다.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
