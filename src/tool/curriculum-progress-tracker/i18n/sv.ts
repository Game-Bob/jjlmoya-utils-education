...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Ange det totala antalet poäng som krävs för examen och fördela återstående kurser över realistiska terminer.' },
    { type: 'paragraph', html: 'Avklarade poäng visar verkliga framsteg, medan planerade kurser endast används för framtida scenarier.' },
    { type: 'paragraph', html: 'Det beräknade genomsnittet beror på de uppskattade betyg du anger för återstående kurser.' },
    { type: 'paragraph', html: 'Jämför flera antaganden i stället för att behandla en prognos som säker.' },
    { type: 'paragraph', html: 'Det nödvändiga betyget visar vilken prestation som krävs för att nå målet.' },
    { type: 'paragraph', html: 'En lättare termin kan ge stabilitet, medan högre belastning kan påskynda poänginsamlingen.' },
    { type: 'paragraph', html: 'Ta hänsyn till tillgänglig tid och den faktiska arbetsmängden för varje kurs när du jämför planer.' },
    { type: 'paragraph', html: 'Exportera planen före större ändringar så att du kan jämföra tidigare scenarier.' },
    { type: 'paragraph', html: 'Använd statusarna klar, pågående och planerad för att hålla simuleringen tydlig.' },
    { type: 'paragraph', html: 'Beräkningen är en allmän vägledning och ersätter inte akademisk rådgivning.' },
    { type: 'paragraph', html: 'Kontrollera viktning, kompensationsregler och examenskrav i universitetets regler.' },
    { type: 'paragraph', html: 'Uppdatera lokalt sparade data efter varje officiellt publicerat resultat.' },
    { type: 'paragraph', html: 'En realistisk plan gör det lättare att mäta framsteg och söka stöd i tid.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
