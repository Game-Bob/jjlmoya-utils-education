...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Mezuniyet için gereken toplam krediyi belirleyin ve kalan dersleri gerçekçi dönemlere dağıtın.' },
    { type: 'paragraph', html: 'Tamamlanan krediler gerçek ilerlemeyi gösterir; planlanan dersler yalnızca geleceği simüle eder.' },
    { type: 'paragraph', html: 'Öngörülen ortalama, kalan dersler için girdiğiniz tahmini notlara bağlıdır.' },
    { type: 'paragraph', html: 'Tek bir tahmini kesin kabul etmek yerine birkaç varsayımı karşılaştırın.' },
    { type: 'paragraph', html: 'Gerekli not, hedefe ulaşmak için kalan derslerde gereken performansı gösterir.' },
    { type: 'paragraph', html: 'Daha hafif bir dönem düzeni koruyabilir, daha yoğun bir plan ise kredi kazanımını hızlandırabilir.' },
    { type: 'paragraph', html: 'Planları karşılaştırırken ayırabileceğiniz zamanı ve derslerin gerçek çalışma yükünü dikkate alın.' },
    { type: 'paragraph', html: 'Büyük değişikliklerden önce planı dışa aktararak eski senaryoları karşılaştırın.' },
    { type: 'paragraph', html: 'Tamamlandı, devam ediyor ve planlandı durumları simülasyonu anlaşılır tutar.' },
    { type: 'paragraph', html: 'Bu hesaplama genel bir rehberdir ve üniversitenin akademik danışmanlığının yerini tutmaz.' },
    { type: 'paragraph', html: 'Not ağırlıklarını, telafi kurallarını ve mezuniyet şartlarını resmi yönetmelikten kontrol edin.' },
    { type: 'paragraph', html: 'Her resmi sonuç yayınlandığında yerel olarak kaydedilen verileri güncelleyin.' },
    { type: 'paragraph', html: 'Gerçekçi bir plan ilerlemeyi ölçmenize ve zamanında destek istemenize yardımcı olur.' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
