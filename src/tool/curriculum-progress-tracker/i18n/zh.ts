...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: '先设定毕业所需的总学分，再把剩余课程分配到合理的学期中。' },
    { type: 'paragraph', html: '已完成学分代表真实进度，计划课程只用于模拟未来结果。' },
    { type: 'paragraph', html: '预测平均成绩取决于你为剩余课程输入的预计分数。' },
    { type: 'paragraph', html: '请比较多个假设，不要把单一预测当成确定结果。' },
    { type: 'paragraph', html: '所需成绩可以说明要达到目标，在剩余课程中需要保持的水平。' },
    { type: 'paragraph', html: '较轻的学期有助于保持稳定，较高的课程负担可能加快学分积累。' },
    { type: 'paragraph', html: '比较计划时还要考虑可用时间和每门课程的实际学习量。' },
    { type: 'paragraph', html: '在进行重要修改前导出计划，方便之后比较旧方案。' },
    { type: 'paragraph', html: '使用已完成、进行中和计划中的状态，可以让模拟结果更清晰。' },
    { type: 'paragraph', html: '这个计算结果是一般参考，不能代替学校的学业咨询。' },
    { type: 'paragraph', html: '请在学校规定中确认成绩权重、补偿规则和毕业要求。' },
    { type: 'paragraph', html: '每次官方成绩公布后，及时更新本地保存的数据。' },
    { type: 'paragraph', html: '现实的计划有助于衡量进度，也能让你更早寻求帮助。' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
