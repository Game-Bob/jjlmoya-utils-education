...
export const content: ToolLocaleContent<CurriculumProgressTrackerUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: '卒業に必要な総単位を設定し、残りの科目を無理のない学期に分けて計画します。' },
    { type: 'paragraph', html: '取得済み単位は実際の進捗を示し、予定科目は将来の結果を試算するために使います。' },
    { type: 'paragraph', html: '予測平均は、未履修科目に入力した予想成績によって変わります。' },
    { type: 'paragraph', html: '一つの予想を確定値と考えず、複数の条件を比較してください。' },
    { type: 'paragraph', html: '必要成績を見ると、目標達成に向けて残りの科目で必要な水準が分かります。' },
    { type: 'paragraph', html: '軽い学期は安定した学習に役立ち、負荷の高い計画は単位取得を早める場合があります。' },
    { type: 'paragraph', html: '計画を比較するときは、使える時間と科目ごとの実際の負荷も考慮しましょう。' },
    { type: 'paragraph', html: '大きく変更する前に計画をエクスポートすると、以前の案を後から確認できます。' },
    { type: 'paragraph', html: '修了、履修中、予定の状態を使うと、シミュレーションの意味を整理できます。' },
    { type: 'paragraph', html: 'この計算は一般的な目安であり、大学の履修相談の代わりにはなりません。' },
    { type: 'paragraph', html: '成績の重み、補償ルール、修了要件は所属大学の規定で確認してください。' },
    { type: 'paragraph', html: '公式の成績が出たら、端末内のデータを更新して計画を現実に合わせます。' },
    { type: 'paragraph', html: '現実的な計画を持つと、進捗を測りやすく、早めに相談する判断もできます。' },
  ],
  faq: faqItems,
  howTo: howToItems,
  bibliography,
