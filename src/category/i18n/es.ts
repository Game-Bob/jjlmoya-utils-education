...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Desde el cálculo estratégico de tus calificaciones hasta el cumplimiento de los estándares internacionales de referenciado bibliográfico, nuestras utilidades están aquí para simplificar las tareas administrativas y que tú te enfoques en el aprendizaje real.' },
    ...
    { type: 'paragraph', html: 'Los profesores y evaluadores son implacables con los errores de formato. Un artículo citado como "Smith, J. (2023). Título." en una referencia y "SMITH, JOHN. 2023. TÍTULO." en otra genera inmediatamente sospechas sobre la calidad de tu investigación. Mantener un estándar consistente es lo que marca la diferencia entre una calificación B y una A.' },
    ...
    { type: 'paragraph', html: 'Nuestras calculadoras te permiten modelar escenarios: "¿Si saco un 7 en este examen, qué nota necesito en el siguiente?" o "¿Cuál es mi nota media después de 5 calificaciones? ¿Puedo recuperarme?" Este pensamiento probabilístico reduce la ansiedad y te permite tomar decisiones estratégicas sobre dónde enfocar tus esfuerzos.' },
    ...
    { type: 'paragraph', html: 'Profesores valoran a estudiantes que entregan trabajos donde cada referencia está perfectamente formateada, donde los argumentos están bien estructurados y donde está claro que el investigador ha invertido tiempo en la excelencia. Nuestra calculadora de notas ponderadas y el generador de citas te dan las herramientas técnicas para que tu esfuerzo intelectual brille correctamente.' },
    { type: 'title', text: 'Preparación para la Universidad y Carreras Profesionales', level: 2 },
    { type: 'paragraph', html: 'La educación de hoy es la empleabilidad de mañana. Universidades de prestigio buscan estudiantes que demuestren rigor metodológico desde el bachillerato. Aprender a citar correctamente, a gestionar tus calificaciones estratégicamente y a planificar tu tiempo es aprender las destrezas que los profesionales usan en investigación, consultoría y análisis.' },
    { type: 'title', text: 'Investigación Metodológica: Construcción de Argumentos Rigurosos', level: 2 },
    { type: 'paragraph', html: 'La investigación académica es más que acumular fuentes; es construir un argumento donde cada referencia apoya una tesis específica. La estructura típica de un trabajo universitario de calidad: 1) Introducción clara del problema, 2) Estado del arte (qué se conoce), 3) Brecha identificada (qué falta), 4) Propuesta/análisis, 5) Conclusiones. Cada paso requiere referencias específicas que demuestren que has leído, entendido y evaluado críticamente tu tema.' },
    { type: 'paragraph', html: 'Las herramientas de cita y cálculo de notas son infraestructura. La verdadera excelencia está en pensar críticamente: ¿Por qué cito este autor? ¿Qué agrega a mi argumento? ¿Contrasta con otra perspectiva? Un estudiante que domina estas destrezas escribe trabajos que destacan, no solo por notas altas, sino por impacto intelectual real. Eso es lo que buscan universidades de élite y lo que los empleadores valoran.' },
