...
const UTILITY_ASSET_ROOT = "/_utilities/education";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/education/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/education/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("education");
